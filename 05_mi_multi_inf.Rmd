...
#remove not reported values due to interference - skip this step
```{r}
...
save(imp_dat_bcep, imp_dat_bdcipp, imp_dat_dnbp, imp_dat_dphp, 
     file = paste0("~/Documents/ope_ssis/data/opfr_imputed_objects_m50.rda"))
```
...
runGeeglmParallel(datasets = c("imp_dat_dphp", "imp_dat_bcep", "imp_dat_bdcipp", "imp_dat_dnbp"), 
                  ...
                  outcomes = c("ss_std_score_c", "com_raw_c", "coop_raw_c", "assert_raw_c","res_raw_c",
                              ...
                              "int_raw_p", "as_raw_p"),
                  outputFolder = "~/Documents/ope_ssis/result/gee_mi_res_march2/")
```
...
```{r}
extractGEEParallel(input_folder="~/Documents/ope_ssis/result/gee_mi_res_march2", 
                   output_folder= "~/Documents/ope_ssis/result/gee_mi_res_march2")
```
