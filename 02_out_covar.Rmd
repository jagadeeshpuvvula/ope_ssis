...
out_cov<- outcome |>
  ...
  select(-c(17:22)) |> # PBDEs (sigma-PBDEs has 59 observations with NA)
  drop_na() # 14 observations with missing all covariate data

write_csv(out_cov, paste0(dat_loc, "out_cov.csv"))

#new version Jan 2025
write_csv(out_cov, "~/Documents/ope_ssis/res_sing_imput/out_cov.csv")
```
